...
X = data_cleaned.drop("2024-05-HomeValue", axis="columns")

# Convert X back to a DataFrame after splitting if it becomes an ndarray
...
for column in X_train.select_dtypes(include=['object']).columns:
    ...
    # Use a mapping approach to handle unseen labels in X_test
